...
export default function ProjectPage({ params }: ProjectPageProps) {
  ...
  // A: Reading progress bar + D: Parallax — single useScroll call
  ...
  const smoothHeaderY = useSpring(headerY, { stiffness: 300, damping: 40 });
  ...
  return (
    <div className="min-h-screen bg-[#000000] text-gray-300">
      ...
      <motion.div
        className="fixed top-0 left-0 right-0 h-[3px] bg-[#0A84FF] z-[60] pointer-events-none"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-36 md:pt-42">
        ...
        >
          {/* D: Parallax — title and pitch only */}
          <motion.h1
          ...
          {/* Role / TechStack / Links — anchored (no parallax) */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              {Array.isArray(project.architecture.tradeoffs) ? (
                <StaggeredList items={project.architecture.tradeoffs} dotColor="#0A84FF" />
              ) : (
                <p className="text-lg text-gray-300 leading-relaxed whitespace-pre-line">
          ...
          <div className="space-y-6">
            ...
            {project.reliability.validation && (
              <div>
                ...
                {project.reliability.validationEdgeCases &&
                  project.reliability.validationEdgeCases.length > 0 && (
                    <div className="rounded-lg overflow-hidden border border-[#2D2D30] bg-[#1E1E1E] shadow-2xl mt-4">
                      ...
                      <div className="p-4">
                        <StaggeredList
                          items={project.reliability.validationEdgeCases}
                          dotColor="#FFBD2E"
                        />
                      </div>
                    </div>
            ...
            <div>
              ...
              {Array.isArray(project.reliability.errorHandling) ? (
                <StaggeredList items={project.reliability.errorHandling} dotColor="#FF453A" />
              ) : (
                <p className="text-lg text-gray-300 leading-relaxed whitespace-pre-line">
        ...
        <Section id="impact" title="Impact & Collaboration">
          {Array.isArray(project.impact) ? (
            <StaggeredList items={project.impact} dotColor="#30D158" />
          ) : (
            <p className="text-lg text-gray-300 leading-relaxed whitespace-pre-line">
